          ...
          <div className=" w-full h-2/3 mx-10 my-5">
            ...
            <form className="flex flex-col gap-3" onSubmit={(e)=>{handleSubmit(e)}}>
              ...
              <div className="flex flex-col gap-1">
                ...
                }} className="w-9/10 px-2 py-1 border border-black rounded-sm outline-0 hover:border-blue-600" type="text" placeholder="Enter Your Password" />
              </div>
                ...
                <button className="w-9/10 bg-blue-600 text-white p-2 rounded-2xl mt-2">Log in</button>
                <p className="text-xs w-9/10 text-gray-600 text-center">Dont have an Account ? <span className="text-xs text-blue-600">Sign Up</span></p>
            </form>
          </div>
