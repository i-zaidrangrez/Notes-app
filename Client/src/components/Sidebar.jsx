  ...
  return (
    <div className="p-4 flex  flex-col h-full">
      ...
      <div className="h-full flex flex-col place-content-between">
        ...
        <h3 className="flex items-center rounded-sm hover:text-green-300 p-2 border border-gray-500 justify-center duration-300 text-xl"> <LogOut color="white" /> Log Out</h3>
      </div>
    </div>
  );
};
